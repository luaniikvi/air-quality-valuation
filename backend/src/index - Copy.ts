...
// function upsertDeviceFromTelemetry(deviceId: string) {
...
//     status: !prev ? 'offline' : computeStatus(prev.last_seen)!,
//   };
...
//   const toMs = toIso ? Date.parse(toIso) : nowTs();
...
//     upsertDeviceFromTelemetry(telemetry.deviceId);
