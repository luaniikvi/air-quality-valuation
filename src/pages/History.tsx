...
export default function History() {
    ...
    const [points, setPoints] = useState<Processed[]>([]);
                                    ...
                                    <>
                                        <DataTable
                                            ...
                                            columns={[
                                                ...
                                                { header: 'Dust (mg/m³)', cell: (r) => (r.dust ?? ''), className: 'whitespace-nowrap' },
                                                { header: 'IAQ (0-100)', cell: (r) => ((r as any).IAQ ?? ''), className: 'whitespace-nowrap' },
